const CACHE='diccionari-insults-v2';
const CORE=['./','./index.html','./styles.css','./app.js','./detail.js','./data/insults.json','./manifest.webmanifest','./privacitat.html','./assets/icon.svg','./assets/at-sign.svg'];
